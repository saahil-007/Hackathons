...
import { User, Mail, Lock, UserCircle2, Phone, Calendar } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      // Process mobile number - only send if it's a valid 10-digit number
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  {mobile && mobile.length > 0 && mobile.length < 10 && (
                    <p className="text-xs text-destructive mt-1">Mobile number must be 10 digits</p>
                  )}
                </div>
              </div>
